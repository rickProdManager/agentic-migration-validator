...
class StaticUiTest(unittest.TestCase):
    ...
    def test_dashboard_defines_operator_error_prevention_affordances(self):
        ...
        self.assertIn("function retryFailedWorkflowRun", app_js)
        ...
        self.assertIn("function workflowFailureSummary", app_js)
        ...
        self.assertIn("Failure code:", app_js)
        self.assertIn("Retry Workflow", app_js)
        self.assertIn("/retry", app_js)
        self.assertIn("data-retry-workflow-run-id", app_js)
        ...
        self.assertIn(".retry-button", styles)
